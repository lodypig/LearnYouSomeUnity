...
public class iTweenWrap
{
	...
	static int CameraFadeFrom(IntPtr L)
	{
		try
		{
			...
			if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(System.Collections.Hashtable)))
			{
	...
	static int FadeFrom(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(System.Collections.Hashtable)))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				System.Collections.Hashtable arg1 = (System.Collections.Hashtable)ToLua.ToObject(L, 2);
	...
	static int Stab(IntPtr L)
	{
		try
		{
			...
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(UnityEngine.AudioClip), typeof(float)))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
	...
	static int PathLength(IntPtr L)
	{
		try
		{
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform[])))
			{
	...
	static int PutOnPath(IntPtr L)
	{
		try
		{
			...
			if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.GameObject), typeof(UnityEngine.Transform[]), typeof(float)))
			{
				UnityEngine.GameObject arg0 = (UnityEngine.GameObject)ToLua.ToObject(L, 1);
				UnityEngine.Transform[] arg1 = ToLua.CheckObjectArray<UnityEngine.Transform>(L, 2);
				float arg2 = (float)LuaDLL.lua_tonumber(L, 3);
				iTween.PutOnPath(arg0, arg1, arg2);
				return 0;
			}
			else if (count == 3 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform), typeof(UnityEngine.Transform[]), typeof(float)))
			{
	...
	static int PointOnPath(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform[]), typeof(float)))
			{
				UnityEngine.Transform[] arg0 = ToLua.CheckObjectArray<UnityEngine.Transform>(L, 1);
				float arg1 = (float)LuaDLL.lua_tonumber(L, 2);
				UnityEngine.Vector3 o = iTween.PointOnPath(arg0, arg1);
	...
	static int DrawLine(IntPtr L)
	{
		try
		{
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Transform[]), typeof(UnityEngine.Color)))
			{
				UnityEngine.Transform[] arg0 = ToLua.CheckObjectArray<UnityEngine.Transform>(L, 1);
				UnityEngine.Color arg1 = ToLua.ToColor(L, 2);
			...
			else if (count == 2 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Vector3[]), typeof(UnityEngine.Color)))
			{
				UnityEngine.Vector3[] arg0 = ToLua.CheckObjectArray<UnityEngine.Vector3>(L, 1);
				UnityEngine.Color arg1 = ToLua.ToColor(L, 2);
				iTween.DrawLine(arg0, arg1);
	...
	static int CameraFadeAdd(IntPtr L)
	{
		try
		{
			...
			else if (count == 1 && TypeChecker.CheckTypes(L, 1, typeof(UnityEngine.Texture2D)))
			{
	...
	static int get_tweens(IntPtr L)
	{
		try
		{
			ToLua.PushObject(L, iTween.tweens);
			return 1;
		}
		catch(Exception e)
		{
	...
	static int get_isRunning(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o == null ? "attempt to index isRunning on a nil value" : e.Message);
		}
	}
