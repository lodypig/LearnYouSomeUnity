...
{
    public static string luaDir = Application.dataPath + "/RawRes/lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/juFrame/Lua/ToLua/Lua";        //tolua lua文件目录
