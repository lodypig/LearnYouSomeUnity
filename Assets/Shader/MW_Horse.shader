Shader "MW/Horse" {
    ...
    SubShader {
		...
		Pass{
			...
			#pragma multi_compile __ HORSE_EFFECT
			...
			fragOuput frag(v2f i): SV_Target
			{
				...
				//环境光处理(微弱)
				c.rgb +=  UNITY_LIGHTMODEL_AMBIENT.xyz * gray.r * 0.05;
