function CreateShahaisishen(ds)
  	--print("CreateShahaisishen")
    ds["lua_logic"] = "Shahaisishen";
    ...
    t.Attack1 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("shahaisishen_attack1", 5.0, ds.id, "");
        end,
    ...
    t.Attack2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("shahaisishen_attack2", 5.0, ds.id, "");
        end,
    ...
    t.Skill1 = {
        ...
        OnEnter = function (ds)
            ...
            --     Fight.DoRotateToTarget(ds, target_ds);
            -- end
            Fight.PlayFollowEffect("shahaisishen_skill1", 5.0, ds.id, "");
            Fight.PlayFollowEffect("shahaisishen_skill_tail", 5.0, ds.id, "tail");
        end,
    ...
    t.Skill2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("shahaisishen_skill2", 5.0, ds.id, "");
        end,
    ...
    t.Skill3 = {
        ...
        OnEnter = function (ds)
            local skill_data = t.Skill3.skill_data;
            local target_id = skill_data.target_id;
            local target_ds = AvatarCache.GetAvatar(target_id);
            if target_ds ~= nil then
                Fight.DoRotateToTarget(ds, target_ds);
            end
            Fight.PlayFollowEffect("shahaisishen_skill3", 5.0, ds.id, "");
        end,
