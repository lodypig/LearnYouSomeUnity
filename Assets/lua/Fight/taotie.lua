function CreateTaotie(ds)
    ...
    t.Attack1 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("taotie_attack1", 5.0, ds.id, "");
        end,
    ...
    t.Attack2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("taotie_attack2", 5.0, ds.id, "");
        end,
    ...
    t.Skill1 = {
        ...
        OnEnter = function (ds)
            ...
            --     Fight.DoRotateToTarget(ds, target_ds);
            -- end
            Fight.PlayFollowEffect("taotie_skill1", 10.0, ds.id, "");
            Fight.PlayFollowEffect("taotie_skill_body", 10.0, ds.id, "tail");
        end,
    ...
    t.Skill2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("taotie_skill2", 10.0, ds.id, "");
            Fight.PlayFollowEffect("taotie_skill_body", 10.0, ds.id, "tail");
