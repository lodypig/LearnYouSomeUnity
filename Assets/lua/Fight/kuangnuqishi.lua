function CreateKuangnuqishi(ds)

    ds["lua_logic"] = "Kuangnuqishi";
    ...
    t.Attack1 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("kuangnuqishi_attack1", 5.0, ds.id, "");
        end,
    ...
    t.Attack2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("kuangnuqishi_attack2", 5.0, ds.id, "");
        end,
    ...
    t.Skill1 = {
        ...
        OnEnter = function (ds)
            ...
            --     Fight.DoRotateToTarget(ds, target_ds);
            -- end
            Fight.PlayFollowEffect("kuangnuqishi_skill1", 5.0, ds.id, "");
            Fight.PlayFollowEffect("kuangnuqishi_skill_body", 5.0, ds.id, "rhand");
        end,
    ...
    t.Skill2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("kuangnuqishi_skill2", 5.0, ds.id, "");
            Fight.PlayFollowEffect("kuangnuqishi_skill_body", 5.0, ds.id, "rhand");
