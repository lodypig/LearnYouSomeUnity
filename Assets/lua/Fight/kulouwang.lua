function CreateKulouwang(ds)

    ds["lua_logic"] = "Kulouwang";
    ...
    t.Attack1 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("kulouwang_attack1", 5.0, ds.id, "");
        end,
    ...
    t.Attack2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("kulouwang_attack2", 5.0, ds.id, "");
        end,
    ...
    t.Attack3 = {
        ...
        OnEnter = function (ds)
            ...
            --     Fight.DoRotateToTarget(ds, target_ds);
            -- end
            Fight.PlayFollowEffect("kulouwang_attack3", 5.0, ds.id, "");
        end,
    ...
    t.Attack4 = {
        ...
        OnEnter = function (ds)
            local skill_data = t.Attack4.skill_data;
            local target_id = skill_data.target_id;
            local target_ds = AvatarCache.GetAvatar(target_id);
            if target_ds ~= nil then
                Fight.DoRotateToTarget(ds, target_ds);
            end
            Fight.PlayFollowEffect("kulouwang_attack4", 5.0, ds.id, "");
