function CreateJiangongdifeiya(ds)

    ds["lua_logic"] = "Jiangongdifeiya";
    ...
    t.Attack1 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("xukongxingzhe_attack1", 5.0, ds.id, "");
        end,
    ...
    t.Skill1 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("jiangongdifeiya1", 5.0, ds.id, "");
        end,
    ...
    t.Skill2 = {
        ...
        OnEnter = function (ds)
            ...
            Fight.PlayFollowEffect("jiangongdifeiya2", 5.0, ds.id, "");
        end,
